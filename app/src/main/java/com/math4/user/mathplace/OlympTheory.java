...
public class OlympTheory extends Fragment {
  ...
  TextView textView;
    ...
    Animation animation;
    static OlympTheory.BounceInterpolator interpolator;
    static  FirebaseFirestore db;




    static List<OlympTheory.Subcategory> getRandomData() {
        final ArrayList<OlympTheory.Subcategory> subcategoryList = new ArrayList<>();
        for(int i=0;i<allComment;i++){
            subcategoryList.add(new OlympTheory.Subcategory(title2,position2));
            subcategoryList.add(new OlympTheory.Subcategory(title2,position2));
        }
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
      ...
      linearLayout=view.findViewById(R.id.textTheory);
        ...
        interpolator = new OlympTheory.BounceInterpolator(0.2, 20);
                    ...
                    public void onComplete(@NonNull com.google.android.gms.tasks.Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                List<OlympTheory.Subcategory> CircleCategories = OlympTheory.getRandomData();
                                ...
                                OlympTheory.SubcategoriesAdapter adapter=new OlympTheory.SubcategoriesAdapter(CircleCategories);
//                              adapter.addComment();
      ...
      if(text.length()!=last){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OlympTopic.viewPager.setCurrentItem(position+1,true);
            }
        });
    ...
    static class SubcategoriesAdapter extends RecyclerView.Adapter<OlympTheory.SubcategoriesAdapter.ViewHolder> {

        static List<OlympTheory.Subcategory> data;

        SubcategoriesAdapter(List<OlympTheory.Subcategory> data) {
            this.data = data;
        }


        @Override
        public OlympTheory.SubcategoriesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.subcategory_list_item_comment, parent, false);
            return new OlympTheory.SubcategoriesAdapter.ViewHolder(view);
        }
...
//            data.remove(position);
            ...
            allComment++;
            data.add(new OlympTheory.Subcategory(title2,position2));
...
//            notifyItemRangeChanged(position, data.size());
        ...
        @Override
        public void onBindViewHolder(final OlympTheory.SubcategoriesAdapter.ViewHolder holder, final int position) {
            final OlympTheory.Subcategory subcategory = data.get(position);
